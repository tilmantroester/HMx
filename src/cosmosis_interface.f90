...
! Assign default values.
  ...
  status = datablock_get_double(block, cosmological_parameters_section, "ks", HMx_config%hm%ks0)
  status = datablock_get_double(block, cosmological_parameters_section, "A", HMx_config%hm%A0)
