...
plot for [i=1:ncos] for [j=1:nz] for [j1=1:nf] for [j2=j1:nf] data(base,'best',i,j1,j2,j) u 1:3 w p lc j1 dt 1 lw 2 noti 'BAHAMAS',\
     for [i=1:ncos] for [j=1:nz] for [j1=1:nf] for [j2=j1:nf] data(base,'orig',i,j1,j2,j) u 1:2 w l lc 0  dt 1 lw 2 noti 'Original HMx',\
     for [i=1:ncos] for [j=1:nz] for [j1=1:nf] for [j2=j1:nf] data(base,'best',i,j1,j2,j) u 1:4 w l lc -1 dt 1 lw 2 noti 'HMcode',\
     for [i=1:ncos] for [j=1:nz] for [j1=1:nf] for [j2=j1:nf] data(base,'best',i,j1,j2,j) u 1:2 w l lc j1 dt 1 lw 2 noti 'Best HMx',\
...
plot 1 w l lt -1 noti,\
     ...
     for [i=1:ncos] for [j=1:nz] for [j1=1:nf] for [j2=j1:nf] data(base,'orig',i,j1,j2,j) u 1:($4/$3) w l lc 0  dt j lw 2 noti,\
